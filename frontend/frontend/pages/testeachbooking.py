    ...
    async def submit_booking(self):
        ...
        if self.resource["type"] == "coworking_space":
            ...
            if not calendar_state.confirmed:
                self.error_message = "Please select and confirm your dates first."# ← guard: not confirmed yet
                return
            if not calendar_state.start_date or not calendar_state.end_date:
                self.error_message = "Please select and confirm your dates first."
                return
                    ...
                    rx.vstack(
                        ...
                        rx.button(
                            ...
                            on_click=rx.cond(
                                ...
                                BookingState.submit_booking,
                                rx.noop(),
                            ),
                            is_disabled=~CalendarState.confirmed,
                            bg=rx.cond(
                                CalendarState.confirmed,
                                "#1E88E5",
                                "#90CAF9",  # grayed-out blue when not confirmed
                            ),
                            color="white",
                            border_radius="8px",
                            padding="12px 0",
            ...
            rx.vstack(
                ...
                rx.cond(
                    ...
                    rx.cond(
                        ...
                        rx.box(
                            rx.hstack(
                                rx.icon("circle-alert", size=16, color="white"),
                                rx.text(
                                    BookingState.error_message,
                                    color="white",
                                    font_size="14px",
