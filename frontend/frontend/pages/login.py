            ...
            rx.box(
                rx.center(
                    rx.vstack(
                        ...
                        rx.text("Email",margin="10px 0 5px 20px",font_size="15px"),
                        rx.input(placeholder="Email", width="400px",bg="white",margin_bottom="10px",height="45px",border_radius="40px",padding_left="20px",color="black",font_size="17px"),
                        
                        rx.text("Password",margin="10px 0 5px 20px",font_size="15px"),
                        rx.input(placeholder="Password", width="400px",bg="white",margin_bottom="10px",height="45px",border_radius="40px",padding_left="20px",color="black",font_size="17px"),
